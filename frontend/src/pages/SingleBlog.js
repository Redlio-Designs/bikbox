    ...
    useEffect(() => {
        fetch(`http://localhost:1337/api/blogs/${id}?populate=*`)
            ...
            .then((blog) => {
                ...
                setImg(blog.data.attributes.featuredimage.data.attributes)
            });
                    ...
                    <div className='row'>
                        <div className='col-lg-12 g-0'>
                            <div className='blog-featured-img'>
                                <SingleImage imgPath={'http://localhost:1337' + img.url} />
                            </div>

                            <div className='blog-content custom-width'>

                                <h1 className='blog-title fz-38 fw-600'>{blog.blogtitle}</h1>
                                ...
                                <div className='blog-content-sec'>
                                    <div className='fz-20 fw-500 color-grey'>{blog.blogcontent}</div>
                                </div>
                            </div>
                        </div>
                    </div>
